...
<body>
	...
	<s:form action="/login">
		...
		<!-- 提交单一布尔值 -->
		<!-- 婚否<input type="radio" name="merried" value="true" /><input type="radio" name="merried" value="false" /> -->
		<!-- 婚否<input type="checkbox" name="merried" value="true"/> -->
		<s:checkbox name="merried" label="婚否"/>
