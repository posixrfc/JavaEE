 ...
 * 
 */
@WebServiceClient(name = "HelloWsImplService", targetNamespace = "http://ws.jdk_ws.atguigu.com/", wsdlLocation = "http://192.168.10.165:8989/jdk_ws/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://ws.jdk_ws.atguigu.com/", "HelloWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.10.165:8989/jdk_ws/hellows?wsdl");
    ...
    public HelloWsImpl getHelloWsImplPort() {
        return super.getPort(new QName("http://ws.jdk_ws.atguigu.com/", "HelloWsImplPort"), HelloWsImpl.class);
    }
    ...
    public HelloWsImpl getHelloWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.jdk_ws.atguigu.com/", "HelloWsImplPort"), HelloWsImpl.class, features);
    }
